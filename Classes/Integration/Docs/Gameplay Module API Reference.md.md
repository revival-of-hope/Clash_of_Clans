# **Gameplay Module Development Manual & Behavior Contract (V2.0)**
...
To achieve "physical isolation" between modules, all implementation details (.cpp) of the Gameplay module are hidden from the outside. External modules (UI, Engine) are **only allowed** to reference header files located in the `Classes/Contract/Gameplay` directory.

**Include Path Standard (Dev C):**

```cpp
// ✅ Correct: Include Contract interfaces
...
When calling Gameplay module interfaces, you **must** adhere to the following Contract. This is the prerequisite for ensuring game logic correctness and memory safety.

### **2.1 Coordinate System Contract**
...
### **2.2 Lifecycle & Ownership Contract**
...
### **2.3 Timing & Sequencing Contract**
...
**Header:** `Classes/Contract/Gameplay/EconomySystem.h`
...
**Header:** `Classes/Contract/Gameplay/CombatResolver.h`
...
**Header:** `Classes/Contract/Gameplay/BaseEntity.h`
...
**Header:** `Classes/Contract/Gameplay/Unit.h`
...
**Header:** `Classes/Contract/Gameplay/Building.h`
...
**Header:** `Classes/Contract/Gameplay/HealthComp.h`
...
The following code demonstrates how to correctly integrate the Gameplay module into a blank scene. This code complies with all Contract and is directly compilable.
...
// [Contract 1] Only include Contract headers
#include "Classes/Contract/Gameplay/Unit.h"
